				...
				<article id="post-<?php the_ID(); ?>" <?php post_class( 'image-attachment' ); ?>>
					<header class="entry-header">
						...
						<nav id="image-navigation" class="navigation" role="navigation">
							...
							<span class="next-image"><?php next_image_link( false, __( 'Next &rarr;', 'eazyest-gallery' ) ); ?></span>
...
?>
						...
						<footer class="entry-meta">
							<?php
								...
								printf( __( '<span class="meta-prep meta-prep-entry-date">Published </span> <span class="entry-date"><time class="entry-date" datetime="%1$s">%2$s</time></span> at <a href="%3$s" title="Link to full-size image">%4$s &times; %5$s</a> in <a href="%6$s" title="Return to %7$s" rel="gallery">%8$s</a>.', 'eazyest-gallery' ),
