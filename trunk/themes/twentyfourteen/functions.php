...
function eazyestgallery_content_nav( $html_id ) {
	global $wp_query;
	$older_posts_link_des = __( 'Next folders page <span class="meta-nav">&rarr;</span>',         'eazyest-gallery' );
	$newer_posts_link_des = __( '<span class="meta-nav">&larr;</span> Previous folders page',         'eazyest-gallery' );	
	$newer_posts_link_asc = __( 'Previous folders page <span class="meta-nav">&rarr;</span>',         'eazyest-gallery' );
	$older_posts_link_asc = __( '<span class="meta-nav">&larr;</span> Next folders page',         'eazyest-gallery' );
	$next_page_link       = __( 'Previous folders page <span class="meta-nav">&rarr;</span> ',     'eazyest-gallery' );
	$previous_page_link   = __( '<span class="meta-nav">&larr;</span> Next folders page', 'eazyest-gallery' );
...
<nav id="folder-nav-2" class="navigation" role="navigation">
	<div class="nav-previous alignright"><?php next_posts_link( $next_posts_link ); ?></div>
	<div class="nav-next alignleft"><?php previous_posts_link( $previous_posts_link ); ?></div>
</nav><!-- #nav-above -->
<?php endif;
}
